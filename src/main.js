...
const myBot = ['u5ad97deb184949152a3908c3eb98fbb0','u5ad97deb184949152a3908c3eb98fbb0'];
...
\n";
        ...
        if(txt === 'sweet' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'sweet' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
